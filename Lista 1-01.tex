...
No caso de $(X, d_2)$ a coisa muda de figura. Seja $x_n$ uma sequência de Cauchy em $X$ que converge 
para algum $x\in \mathbb{R}$ (tal $x$ existe pois $\mathbb{R}$ é completo. Ora, então
